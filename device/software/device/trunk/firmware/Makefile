#####################################################################
#																	 
#	Created by u'nSP IDE		12:20:04	07/27/09
#
#####################################################################
...
INCLUDES	= -I"C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware" -I"C:/Program Files/Generalplus/unSPIDE 3.0.1/library/include" -I"C:/Program Files/Generalplus/unSPIDE 3.0.1/library/include/sys" -I"./Component/Include/FS"

BODY	= -body GPL162003_CS0Flash -nobdy -bfile "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System.bdy"
...
"$(OUTDIR)\Resource.obj": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Resource.asm" 
	$(AS) $(ASFLAGS) $(INCLUDES) -o "$(OUTDIR)\Resource.obj" "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Resource.asm" 

"$(OUTDIR)\app_exception.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\app_exception.c" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/app_exception.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/app_exception.c" 
...
"$(OUTDIR)\lists.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\lists.c" ".\Application\TalkingBook\Include\talkingbook.h" ".\Application\TalkingBook\Include\files.h" ".\Application\TalkingBook\Include\audio.h" ".\Application\TalkingBook\Include\containers.h" ".\Application\TalkingBook\Include\lists.h" ".\Application\TalkingBook\Include\util.h" "Component\Include\FS\vfs.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/lists.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/lists.c" 

"$(OUTDIR)\lists.obj": "$(OUTDIR)\lists.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\lists.obj" "$(OUTDIR)\lists.asm" 

"$(OUTDIR)\macro.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\macro.c" ".\Application\TalkingBook\Include\talkingbook.h" ".\Application\TalkingBook\Include\device.h" ".\Application\TalkingBook\Include\files.h" ".\Application\TalkingBook\Include\macro.h" ".\Application\TalkingBook\Include\util.h" "Component\Include\component_head.h" "Component\Include\FS\vfs.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/macro.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/macro.c" 

"$(OUTDIR)\macro.obj": "$(OUTDIR)\macro.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\macro.obj" "$(OUTDIR)\macro.asm" 

"$(OUTDIR)\mainLoop.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\mainLoop.c" ".\Application\TalkingBook\Include\talkingbook.h" ".\Application\TalkingBook\Include\containers.h" ".\Application\TalkingBook\Include\timeline.h" ".\Application\TalkingBook\Include\device.h" ".\Application\TalkingBook\Include\files.h" ".\Application\TalkingBook\Include\startup.h" ".\Application\TalkingBook\Include\sys_counters.h" ".\Application\TalkingBook\Include\audio.h" ".\Application\TalkingBook\Include\pkg_ops.h" ".\Application\TalkingBook\Include\parsing.h" ".\Application\TalkingBook\Include\macro.h" ".\Application\TalkingBook\Include\d2d_copy.h" ".\Application\TalkingBook\Include\mainLoop.h" ".\Application\TalkingBook\Include\util.h" ".\Application\TalkingBook\Include\lists.h" "Component\Include\component_head.h" "Component\Include\FS\vfs.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/mainLoop.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/mainLoop.c" 

"$(OUTDIR)\mainLoop.obj": "$(OUTDIR)\mainLoop.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\mainLoop.obj" "$(OUTDIR)\mainLoop.asm" 

"$(OUTDIR)\parsing.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\parsing.c" ".\Application\TalkingBook\Include\talkingbook.h" ".\Application\TalkingBook\Include\files.h" ".\Application\TalkingBook\Include\device.h" ".\Application\TalkingBook\Include\containers.h" ".\Application\TalkingBook\Include\parsing.h" ".\Application\TalkingBook\Include\util.h" ".\Application\TalkingBook\Include\lists.h" "Component\Include\FS\vfs.h" "Component\Include\component_head.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/parsing.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/parsing.c" 

"$(OUTDIR)\parsing.obj": "$(OUTDIR)\parsing.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\parsing.obj" "$(OUTDIR)\parsing.asm" 

"$(OUTDIR)\pkg_ops.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\pkg_ops.c" ".\Application\TalkingBook\Include\talkingbook.h" ".\Application\TalkingBook\Include\device.h" ".\Application\TalkingBook\Include\files.h" ".\Application\TalkingBook\Include\lists.h" ".\Application\TalkingBook\Include\containers.h" ".\Application\TalkingBook\Include\audio.h" ".\Application\TalkingBook\Include\pkg_ops.h" ".\Application\TalkingBook\Include\util.h" "Component\Include\component_head.h" "Component\Include\FS\vfs.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/pkg_ops.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/pkg_ops.c" 

"$(OUTDIR)\pkg_ops.obj": "$(OUTDIR)\pkg_ops.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\pkg_ops.obj" "$(OUTDIR)\pkg_ops.asm" 

"$(OUTDIR)\startup.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\startup.c" ".\Application\TalkingBook\Include\talkingbook.h" ".\Application\TalkingBook\Include\files.h" ".\Application\TalkingBook\Include\device.h" ".\Application\TalkingBook\Include\parsing.h" ".\Application\TalkingBook\Include\macro.h" ".\Application\TalkingBook\Include\sys_counters.h" ".\Application\TalkingBook\Include\startup.h" ".\Application\TalkingBook\Include\util.h" ".\Application\TalkingBook\Include\containers.h" ".\Application\TalkingBook\Include\lists.h" "Component\Include\FS\vfs.h" "Component\Include\component_head.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/startup.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/startup.c" 

"$(OUTDIR)\startup.obj": "$(OUTDIR)\startup.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\startup.obj" "$(OUTDIR)\startup.asm" 

"$(OUTDIR)\sys_counters.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\sys_counters.c" ".\Application\TalkingBook\Include\talkingbook.h" ".\Application\TalkingBook\Include\files.h" ".\Application\TalkingBook\Include\sys_counters.h" ".\Application\TalkingBook\Include\util.h" "Component\Include\FS\vfs.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/sys_counters.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/sys_counters.c" 

"$(OUTDIR)\sys_counters.obj": "$(OUTDIR)\sys_counters.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\sys_counters.obj" "$(OUTDIR)\sys_counters.asm" 

"$(OUTDIR)\timeline.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\timeline.c" ".\Application\TalkingBook\Include\talkingbook.h" ".\Application\TalkingBook\Include\device.h" ".\Application\TalkingBook\Include\containers.h" ".\Application\TalkingBook\Include\timeline.h" ".\Application\TalkingBook\Include\util.h" ".\Application\TalkingBook\Include\lists.h" "Component\Include\component_head.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/timeline.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/timeline.c" 

"$(OUTDIR)\timeline.obj": "$(OUTDIR)\timeline.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\timeline.obj" "$(OUTDIR)\timeline.asm" 

"$(OUTDIR)\util.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Application\TalkingBook\util.c" ".\Application\TalkingBook\Include\app_exception.h" ".\Application\TalkingBook\Include\util.h" ".\Component\Include\FS\typedef.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\string.h" "C:\Program Files\Generalplus\unSPIDE 3.0.1\library\include\stddef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/util.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Application/TalkingBook/util.c" 

"$(OUTDIR)\util.obj": "$(OUTDIR)\util.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\util.obj" "$(OUTDIR)\util.asm" 

"$(OUTDIR)\SD.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Component\FS\SD.c" ".\Component\Include\FS\typedef.h" ".\Component\Include\FS\DriverLayer.h" ".\Component\Include\FS\typedef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/SD.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Component/FS/SD.c" 

"$(OUTDIR)\SD.obj": "$(OUTDIR)\SD.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\SD.obj" "$(OUTDIR)\SD.asm" 

"$(OUTDIR)\FS_user_nos.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Component\FS\FS_user_nos.c" "System\include\system\GPL162002.h" "Component\Include\FS\typedef.h" "Application\TalkingBook\Include\sys_counters.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/FS_user_nos.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Component/FS/FS_user_nos.c" 

"$(OUTDIR)\FS_user_nos.obj": "$(OUTDIR)\FS_user_nos.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\FS_user_nos.obj" "$(OUTDIR)\FS_user_nos.asm" 

"$(OUTDIR)\nls_ascii.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Component\FS\nls_ascii.c" ".\Component\Include\FS\vfs.h" ".\Component\Include\FS\Typedef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/nls_ascii.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Component/FS/nls_ascii.c" 

"$(OUTDIR)\nls_ascii.obj": "$(OUTDIR)\nls_ascii.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\nls_ascii.obj" "$(OUTDIR)\nls_ascii.asm" 

"$(OUTDIR)\DrvStruct.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Component\FS\DrvStruct.c" ".\Component\Include\FS\DriverLayer.h" ".\Component\Include\FS\typedef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/DrvStruct.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Component/FS/DrvStruct.c" 

"$(OUTDIR)\DrvStruct.obj": "$(OUTDIR)\DrvStruct.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\DrvStruct.obj" "$(OUTDIR)\DrvStruct.asm" 

"$(OUTDIR)\nls_codepage.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Component\FS\nls_codepage.c" ".\Component\Include\FS\vfs.h" ".\Component\Include\FS\Typedef.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/nls_codepage.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Component/FS/nls_codepage.c" 
...
"$(OUTDIR)\isr.obj": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\isr.asm" 
	$(AS) $(ASFLAGS) $(INCLUDES) -o "$(OUTDIR)\isr.obj" "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\isr.asm" 

"$(OUTDIR)\ServiceLoop.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\ServiceLoop.c" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/ServiceLoop.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/System/ServiceLoop.c" 

"$(OUTDIR)\ServiceLoop.obj": "$(OUTDIR)\ServiceLoop.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\ServiceLoop.obj" "$(OUTDIR)\ServiceLoop.asm" 

"$(OUTDIR)\SysWaitMode.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysWaitMode.c" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/SysWaitMode.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/System/WaitMode/SysWaitMode.c" 

"$(OUTDIR)\SysWaitMode.obj": "$(OUTDIR)\SysWaitMode.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\SysWaitMode.obj" "$(OUTDIR)\SysWaitMode.asm" 

"$(OUTDIR)\SysOn2OffHook.obj": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysOn2OffHook.asm" 
	$(AS) $(ASFLAGS) $(INCLUDES) -o "$(OUTDIR)\SysOn2OffHook.obj" "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysOn2OffHook.asm" 

"$(OUTDIR)\SysIntoHighSpeed.obj": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysIntoHighSpeed.asm" 
	$(AS) $(ASFLAGS) $(INCLUDES) -o "$(OUTDIR)\SysIntoHighSpeed.obj" "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysIntoHighSpeed.asm" 

"$(OUTDIR)\SysIntorWaitMode.obj": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysIntorWaitMode.asm" 
	$(AS) $(ASFLAGS) $(INCLUDES) -o "$(OUTDIR)\SysIntorWaitMode.obj" "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysIntorWaitMode.asm" 

"$(OUTDIR)\SysOff2OnHook.obj": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysOff2OnHook.asm" 
	$(AS) $(ASFLAGS) $(INCLUDES) -o "$(OUTDIR)\SysOff2OnHook.obj" "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysOff2OnHook.asm" 

"$(OUTDIR)\SysIntoHaltMode.obj": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysIntoHaltMode.asm" 
	$(AS) $(ASFLAGS) $(INCLUDES) -o "$(OUTDIR)\SysIntoHaltMode.obj" "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\WaitMode\SysIntoHaltMode.asm" 

"$(OUTDIR)\SysException.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\SysException.c" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/SysException.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/System/SysException.c" 
...
"$(OUTDIR)\ucBS_Hook.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\System\Buddy\ucBS_Hook.c" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/ucBS_Hook.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/System/Buddy/ucBS_Hook.c" 

"$(OUTDIR)\ucBS_Hook.obj": "$(OUTDIR)\ucBS_Hook.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\ucBS_Hook.obj" "$(OUTDIR)\ucBS_Hook.asm" 

"$(OUTDIR)\main.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\main.c" ".\system\include\system_head.h" ".\driver\include\driver_head.h" ".\component\include\component_head.h" ".\Application\TalkingBook\Include\mainloop.h" "System\include\system\GPL162002.h" "System\include\system\GPL162001ISR.h" "System\include\system\SysException.h" "System\include\system\Sys_GV.h" "System\include\WaitMode\SysWaitMode.h" "System\include\Message\Message.h" "System\include\ExtMem\unExtMem.h" "System\include\buddy\ucBS.h" "system\include\system\unSPMACRO.h" "driver\include\SD\SDCDriver.h" "driver\include\NandDriver\Nand2_Oper.h" "driver\include\NandDriver\nanddriver.h" "Component\Include\FS\typedef.h" "Component\Include\FS\vfs.h" "Component\Include\speech\algorithm.h" "Component\Include\speech\sacm_API.h" "Component\Include\speech\MP3.h" "Component\Include\speech\SACM_GV.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/main.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/main.c" 

"$(OUTDIR)\main.obj": "$(OUTDIR)\main.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\main.obj" "$(OUTDIR)\main.asm" 

"$(OUTDIR)\BodyInit.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\BodyInit.c" ".\system\include\system_head.h" ".\driver\include\driver_head.h" ".\component\include\component_head.h" "System\include\system\GPL162002.h" "System\include\system\GPL162001ISR.h" "System\include\system\SysException.h" "System\include\system\Sys_GV.h" "System\include\WaitMode\SysWaitMode.h" "System\include\Message\Message.h" "System\include\ExtMem\unExtMem.h" "System\include\buddy\ucBS.h" "system\include\system\unSPMACRO.h" "driver\include\SD\SDCDriver.h" "driver\include\NandDriver\Nand2_Oper.h" "driver\include\NandDriver\nanddriver.h" "Component\Include\FS\typedef.h" "Component\Include\FS\vfs.h" "Component\Include\speech\algorithm.h" "Component\Include\speech\sacm_API.h" "Component\Include\speech\MP3.h" "Component\Include\speech\SACM_GV.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/BodyInit.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/BodyInit.c" 

"$(OUTDIR)\BodyInit.obj": "$(OUTDIR)\BodyInit.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\BodyInit.obj" "$(OUTDIR)\BodyInit.asm" 

"$(OUTDIR)\libgloss.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\libgloss.c" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/libgloss.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/libgloss.c" 

"$(OUTDIR)\libgloss.obj": "$(OUTDIR)\libgloss.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\libgloss.obj" "$(OUTDIR)\libgloss.asm" 

"$(OUTDIR)\USBD.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\USBD.c" ".\Reprog\GPL162002.h" ".\Reprog\USB_Flash_reprog.h" "reprog\USBD_Define.h" "reprog\USBD.h" "Driver\Include\USB\USBD_Define.h" "Driver\Include\USB\USBD.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/USBD.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Reprog/USBD.c" 
...
"$(OUTDIR)\USB_ID.obj": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\USB_ID.asm" 
	$(AS) $(ASFLAGS) $(INCLUDES) -o "$(OUTDIR)\USB_ID.obj" "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\USB_ID.asm" 

"$(OUTDIR)\USB_Flash_reprog.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\USB_Flash_reprog.c" ".\Reprog\USB_Flash_reprog.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/USB_Flash_reprog.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Reprog/USB_Flash_reprog.c" 
...
"$(OUTDIR)\Flash_reprog_boot.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\Flash_reprog_boot.c" ".\Reprog\GPL162002.h" ".\Reprog\USB_Flash_reprog.h" "Reprog\USBD_Define.h" "Reprog\USBD.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/Flash_reprog_boot.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Reprog/Flash_reprog_boot.c" 
...
"$(OUTDIR)\SD_reprog.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\SD_reprog.c" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/SD_reprog.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Reprog/SD_reprog.c" 

"$(OUTDIR)\SD_reprog.obj": "$(OUTDIR)\SD_reprog.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\SD_reprog.obj" "$(OUTDIR)\SD_reprog.asm" 

"$(OUTDIR)\SD_reprog_finish.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\SD_reprog_finish.c" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/SD_reprog_finish.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Reprog/SD_reprog_finish.c" 
...
"$(OUTDIR)\USBD_Export.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\USBD_Export.c" "System\Include\System\GPL162002.h" "Reprog\USBD_Define.h" "Reprog\USBD.h" "Driver\Include\USB\USBD_Define.h" "Driver\Include\USB\USBD.h" "Reprog\USB_Flash_reprog.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/USBD_Export.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Reprog/USBD_Export.c" 

"$(OUTDIR)\USBD_Export.obj": "$(OUTDIR)\USBD_Export.asm"
	$(AS) $(CASFLAGS) $(INCLUDES) -o "$(OUTDIR)\USBD_Export.obj" "$(OUTDIR)\USBD_Export.asm" 

"$(OUTDIR)\Space.asm": "C:\Documents and Settings\Cliff\My Documents\svn\software\device\trunk\firmware\Reprog\Space.c" ".\Component\Include\FS\typedef.h" ".\Component\Include\FS\DriverLayer.h" ".\Component\Include\FS\typedef.h" "Reprog/USBD_Define.h" "Reprog/USBD.h" "System\include\system\GPL162002.h" "Component\Include\FS\typedef.h" "application\talkingbook\include\talkingbook.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
	$(CC) $(CFLAGS) -o "$(OUTDIR)/Space.asm" "C:/Documents and Settings/Cliff/My Documents/svn/software/device/trunk/firmware/Reprog/Space.c" 
