...
?USB_Dvice:
.external _USB_ISR_PTR
		 R3 = [_USB_ISR_PTR]            	// [28:606]  P
	     R4 = [_USB_ISR_PTR+1]            	// [30:606]  P+1
		call MR
//		call _USB_ISR
...
.external _USB_INSERT_PTR
		 R3 = [_USB_INSERT_PTR]            	// [28:606]  P
	     R4 = [_USB_INSERT_PTR+1]            	// [30:606]  P+1
		call MR
