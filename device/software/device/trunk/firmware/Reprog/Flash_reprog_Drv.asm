...
.external R_Descriptor_High
.external R_Descriptor_Low
.external _Max_LUN
.external _R_EP0DataCount
.external _R_CBW_PKT
.external _CSW_Residue
.external _CSW_Status
.external USB_RW_Buffer
.external _DeviceVersionInfo
.external _USB_Status
.external _Bulk_Stall
.external _R_USB_State_Machine
.external _USBWriteProtect
.external _R_USB_Suspend
.external _R_USB_RW_Busy
.external _Sense_Code
.external _CDROMEnable
.external _ScsiFlexPage
.external _ScsiModeSense10CDROM_End
.external _ScsiModeSense10CDROM
.external _ScsiFlexPage_End
.external _CDROMDelay
...
.include .\Reprog\USBD_Define.inc
//.include NandDriver.inc

.public _FP_Receive_CBW_PKT
.public _FP_Request_Sense
.public _FP_Inquiry
.public _FP_Mode_Sense_06
.public _FP_Prevent_Allow_Medium_removal
.public _FP_Read_Format_Capacities
.public _FP_Read_Capacity

.public _FP_GetCMDValue
.public _FP_GetLBA
.public _FP_GetTransLeng
.public _FP_GetLUN
.public _FP_GetCSWLength
.public _FP_RD_Until_Bulk_IN_NACK
.public _FP_RD_Until_Bulk_OUT_NACK
.public _FP_GetBufferPointer
.public _FP_GetCMDValueEx
.public _FP_ReadDriveInfoTable
.public _FP_TxUSB_RW_Buffer
.public _FP_RxUSB_RW_Buffer
.public _FP_GetICVersion
//.public _Request_ReadID		//add by zhangxh
.public _FP_GotoRam
.public _FP_CallRam
.public _FP_USB_Initial;
.public	FP_F_USB_Initial;
.public _FP_TxUSB_RW_Buffer_Word
.public _FP_Send_To_USB_DMA_USB
.public _FP_Receive_From_USB_DMA_USB
.public _FP_Read_CDROM_Capacity
.external _FP_USB_Insert_TimeOut
.external _FP_CheckCDRomValid

FP_USB_Code_ROM:	.section .code//, .addr=0x40000
...
//=======================================================
.public _FP_Get_Descriptor_Length
_FP_Get_Descriptor_Length:
		push bp to [sp]
		bp=sp+1
		r1=[bp+3]
...
//Return:		None
//=======================================================
.public _FP_Send_8_Bytes
.public FP_F_Send_8_Bytes
_FP_Send_8_Bytes:
FP_F_Send_8_Bytes:
		push r1,r4 to [sp]
...
//Return:		None
//=======================================================
.public _FP_Send_Remain_Bytes
_FP_Send_Remain_Bytes:
		push r1,r5 to [sp]
		r1=[R_Descriptor_High]
		ds=r1
		r1=[R_Descriptor_Low]
...
//		jne ?L_LUN_1
	...
	?L_Byte3:
		...
		retf
////////////////////////////////////////////////////////////////
_FP_Prevent_Allow_Medium_removal:
		push r1,r2 to [sp]
...
////////////////////////////////////////////////////////////////
_FP_TxUSB_RW_Buffer_Word:
		push bp to [sp]
		bp = sp+1
		r1 = [bp+3]		
		r2 = [bp+4]		
		call FP_TxUSB_RW_Buffer_Word
		pop	bp from [sp]
		retf

FP_TxUSB_RW_Buffer_Word:		
		push r1, r5 to [sp]
		bp = USB_RW_Buffer
		bp += r2
		r2 = r1				//length
...
_FP_CheckFIFOTxFinish:
	...
	?L_CheckFIFOTimeout:	
		...
		call _FP_RD_Until_Bulk_IN_NACK
		pop r1, r2 from [sp]
		retf		
...
_FP_ReplyFlexPage:
	...
	// Program Unit: USBDSuspend_CallBack
.public	_FP_USBDSuspend_CallBack
_FP_USBDSuspend_CallBack: .proc	
	// old_frame_pointer = 0
	// return_address = 1
// 552  //////////////////////////////////////////////////////////////////////////////////////////////
// 553  //This function will be called if PC run to be suspend or device be plug out.
// 554  //////////////////////////////////////////////////////////////////////////////////////////////
// 555  void USBDSuspend_CallBack()
// 556  {
BB1_PU5:	// 0x4e9
// BB:1 cycle count: 12
// 557   	R_USB_Suspend=1;	//set R_USB_Suspend=1 will break out usb service loop.
	     R3 = 1                   	// [0:557]  
	     DS = seg(_R_USB_Suspend) 	// [1:557]  R_USB_Suspend
	     R4 = (_R_USB_Suspend)    	// [2:557]  R_USB_Suspend
	     DS:[R4] = R3             	// [4:557]  
	     retf                     	// [6:557]  
	.endp	
.code

	// Program Unit: EP0_DataPointer_CallBack
.public	_FP_EP0_DataPointer_CallBack
_FP_EP0_DataPointer_CallBack: .proc	
	// old_frame_pointer = 0
	// return_address = 1
// 561  //Return 1, if you want to redirect R_Descriptor_High and R_Descriptor_Low address.
// 562  //Return 0, use default reply info.
// 563  ///////////////////////////////////////////////////////////////////////////////////////////////
// 564  int EP0_DataPointer_CallBack(int nTableType)
// 565  {
BB1_PU6:	// 0x4ef
// BB:1 cycle count: 7
// 566  	
...
.public 	_FP_Check_SDC_Present
_FP_Check_SDC_Present: .proc	
	// IOStatus = 0
	// ret = 1
	// old_frame_pointer = 2
	// return_address = 3
// 596  // If SDC is inserted, please initialize the SDC and set R_SDC_Present to 1 and call fUSB_SDCardPlugIn().
// 597  // If SDC is removed, please clear R_SDC_Present to 0 and call fUSB_SDCardPullOut().
// 598  ///////////////////////////////////////////////////////////////////////////////////////////////////////////
// 599  void Check_SDC_Present(void)
// 600  {
BB1_PU9:	// 0x514
// BB:1 cycle count: 7
	     push BP to [SP]          	// [0:600]  
// 619  			fUSB_SDCardPullOut();		//call this function to notify USB library SD card pull-out
// 620  		}
// 621  		
// 622  		//Check SD Card write protect
