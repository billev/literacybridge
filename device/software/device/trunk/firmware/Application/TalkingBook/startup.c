...
void setDefaults(void) {
	...
	TRIP1_VOLTAGE_RANGE			  = DEFAULT_TRIP1_VOLTAGE_RANGE;
	TRIP1_PLAY_RATE				  = DEFAULT_TRIP1_PLAY_RATE;
	TRIP2_VOLTAGE_RANGE			  = DEFAULT_TRIP2_VOLTAGE_RANGE;
	TRIP2_PLAY_RATE				  = DEFAULT_TRIP2_PLAY_RATE;
	TRIP_OTHER_PLAY_RATE		  = DEFAULT_TRIP_OTHER_PLAY_RATE;
	TRIP1_PAUSED_RATE		      = DEFAULT_TRIP1_PAUSED_RATE;
	TRIP2_PAUSED_RATE			  = DEFAULT_TRIP2_PAUSED_RATE;
	TRIP_OTHER_PAUSED_RATE		  = DEFAULT_TRIP_OTHER_PAUSED_RATE;
...
//				else if (!strcmp(name,(char *)"MAX_PWR_CYCLES_IN_LOG")) MAX_PWR_CYCLES_IN_LOG=strToInt(value);
				...
				else if (!strcmp(name,(char *)"TRIP1_VOLTAGE_RANGE")) TRIP1_VOLTAGE_RANGE=strToInt(value);
				else if (!strcmp(name,(char *)"TRIP1_PLAY_RATE")) TRIP1_PLAY_RATE=strToInt(value);
				else if (!strcmp(name,(char *)"TRIP2_VOLTAGE_RANGE")) TRIP2_VOLTAGE_RANGE=strToInt(value);
				else if (!strcmp(name,(char *)"TRIP2_PLAY_RATE")) TRIP2_PLAY_RATE=strToInt(value);
				else if (!strcmp(name,(char *)"TRIP_OTHER_PLAY_RATE")) TRIP_OTHER_PLAY_RATE=strToInt(value);
				else if (!strcmp(name,(char *)"TRIP1_PAUSED_RATE")) TRIP1_PAUSED_RATE=strToInt(value);
				else if (!strcmp(name,(char *)"TRIP2_PAUSED_RATE")) TRIP2_PAUSED_RATE=strToInt(value);
				else if (!strcmp(name,(char *)"TRIP_OTHER_PAUSED_RATE")) TRIP_OTHER_PAUSED_RATE=strToInt(value);
		}
	}
	if (!goodPass) {
		ret = -1;
...
//		SAV_CONFIG_STRING (MACRO_FILE);
		...
		SAV_CONFIG_INT (TRIP1_VOLTAGE_RANGE);
		SAV_CONFIG_INT (TRIP1_PLAY_RATE);
		SAV_CONFIG_INT (TRIP2_VOLTAGE_RANGE);
		SAV_CONFIG_INT (TRIP2_PLAY_RATE);				
		SAV_CONFIG_INT (TRIP_OTHER_PLAY_RATE);
		SAV_CONFIG_INT (TRIP1_PAUSED_RATE);
		SAV_CONFIG_INT (TRIP2_PAUSED_RATE);
		SAV_CONFIG_INT (TRIP_OTHER_PAUSED_RATE);
...
#define SET_CONFIG_INT(key) key = cfg. ## key	
	...
	SET_CONFIG_INT(TRIP1_VOLTAGE_RANGE);
	SET_CONFIG_INT(TRIP1_PLAY_RATE);
	SET_CONFIG_INT(TRIP2_VOLTAGE_RANGE);
	SET_CONFIG_INT(TRIP2_PLAY_RATE);				
	SET_CONFIG_INT(TRIP_OTHER_PLAY_RATE);
	SET_CONFIG_INT(TRIP1_PAUSED_RATE);
	SET_CONFIG_INT(TRIP2_PAUSED_RATE);
	SET_CONFIG_INT(TRIP_OTHER_PAUSED_RATE);
...
#define CHKCFG(key) if(cfg-> ## key != key) logString( # key, BUFFER), err++
	...
	CHKCFG(TRIP1_VOLTAGE_RANGE);
	CHKCFG(TRIP1_PLAY_RATE);
	CHKCFG(TRIP2_VOLTAGE_RANGE);
	CHKCFG(TRIP2_PLAY_RATE);				
	CHKCFG(TRIP_OTHER_PLAY_RATE);
	CHKCFG(TRIP1_PAUSED_RATE);
	CHKCFG(TRIP2_PAUSED_RATE);
	CHKCFG(TRIP_OTHER_PAUSED_RATE);
