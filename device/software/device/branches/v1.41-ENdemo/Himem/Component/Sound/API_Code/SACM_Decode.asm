...
.external R_MP3SpeedCtrl_Flag
.endif	//C_MP3SpeedControl
.endif	//MP3_Used

.ifdef WAV_Used					//added by chengye 2007/7/9
.external F_Wav_Init
.external F_Wav_SetSampleRate
.external F_Wav_Dec
.external F_Wav_Enc_Init
.external F_Wav_Enc
//.external R_SACM_Encode_Count_L
//.external R_SACM_Encode_Count_H
.external _R_LengthWAV_Header
...
.ifdef MP3_Used								
L_MP3_Dec_Proc:									
		R1 = [R_SACM_MP3_Decode_In_PTR];		
		[R_SACM_MP3_DECODE_IN_LENGTH] = R1;	
...
.ifdef	C_MP3SpeedControl						//added for MP3 SpeedControl		
		...
		r1 = [R_SACM_DAC_Out_PTR_Decode];
		[R_SACM_DAC_Out_PTR_Decode_temp] = r1;
						
		r1 = R_SACM_MP3_Decode_Out_Buffer;
		[R_SACM_DAC_Out_PTR_Decode] = r1;
		jmp	MP3_dec_proc_conti?	
no_speed?:
		r1 = [R_SACM_DAC_Out_PTR_Decode];
		[R_SACM_DAC_Out_PTR_Decode] = r1;		
MP3_dec_proc_conti?:	
...
.endif
		...
		call mr
		pop	r3,r4 from [sp]
		//CALL MP3_DEC_PROC_Psuedo					
		//////////////////
		
.ifdef	C_MP3SpeedControl							//modify by chengye according to jacklin 2007/7/25
		r2 = [R_MP3SpeedCtrl_Flag]
		jz	skip?
		r2 = [R_SACM_DAC_Out_PTR_Decode_temp];
...
//***************************************************		
.ifdef	C_WAV_SpeedControl                   //20090216					
		r1 = R_SACM_Decode_Out_Buffer;    	
		[R_SACM_Decode_Out_PTR] = r1;	  
.else									  
		r1 = [R_SACM_DAC_Out_PTR_Decode]; 
...
.ifdef ETTS_Used	
	.dw	offset 	L_Not_Encode_Proc		//add by chengye 2007/4/18
.endif

.ifdef	S320_Used	
	.dw	offset	L_Not_Encode_Proc		//add by chengye 2007/4/28
.endif
...
.ifdef	WAV_Used	
	.dw	offset 	L_SACM_WAV_Pro_Init			//added by chengye 2007/7/9	
.endif	

.ifdef ETTS_Used	
	.dw	offset 	L_SACM_Not_Pro_Init		//add by chengye 2007/4/18
.endif

.ifdef	S320_Used	
	.dw	offset	L_SACM_Not_Pro_Init		//add by chengye 2007/4/28
.endif
...
.ifdef ETTS_Used	
	.dw	offset 	L_SACM_Not_Finish_Pro		//add by chengye 2007/4/18
.endif

.ifdef	S320_Used	
	.dw	offset	L_SACM_Not_Finish_Pro		//add by chengye 2007/4/28
.endif
