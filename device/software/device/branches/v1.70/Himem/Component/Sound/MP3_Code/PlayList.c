...
//========================================================
// Function Name:	Snd_MP3Player_SeekTime
// Syntax:		Snd_MP3Player_SeekTime(long milisecond,int orientation)
...
//========================================================
// Function Name:	Snd_A128_SACM_PlayFAT
// Syntax:		Snd_A128_PlayFAT(const char *filename)
// Purpose: 	Play A128 from FAT 			 
// Note:		NO
// Parameter : 	filename:	the path of MP3 file
