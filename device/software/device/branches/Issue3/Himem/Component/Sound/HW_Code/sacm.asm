...
//*****************************************************************************
//*****************************************************************************
// External variable declaration Area
//*****************************************************************************
//*****************************************************************************
...
.public F_Wav_SetSampleRate
//input: r1
F_Wav_SetSampleRate:		.proc
	push r2 ,r3 to [sp]
	r2 = seg T_Wav_DAC_Timer;
	ds = r2
	r2 = offset T_Wav_DAC_Timer;
?loop:
	r3 = ds:[r2++];
	cmp r1,r3
	jne ?loop		
	r3 = offset T_Wav_DAC_Timer +1
	r2 -= r3			//r2 is offset
	r3 = seg T_MP3_DAC_Timer
	ds = r3
...
.external R_MP3_Sf_ind			
.public F_SP_SACM_MP3_SetSampleRate	
F_SP_SACM_MP3_SetSampleRate:	
		push r3,r4 to [sp];			
		r3 = [R_MP3_Sf_ind];		
		
//added for MP3 SpeedControl
.ifdef C_MP3SpeedControl		
		R4 = [R_MP3SpeedCtrl_Flag]
		jz ?_Cont_0		
		cmp r3,2;
		ja ?_Cont_0;		
		r3 += 3;
